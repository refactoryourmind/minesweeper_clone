...
public class Minesweeper extends JPanel
{
	...
	public void restartGame()
	{
		try
		{
			int newGameSizeX = Integer.parseInt(mySizeXField.getText());
			int newGameSizeY = Integer.parseInt(mySizeYField.getText());
			int newGameNumMines = Integer.parseInt(myNumMinesField.getText());
